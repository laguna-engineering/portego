...
/**
 * Whether the reader's click is still active. A click inside the frame also
 * activates this page, so a document writing entries on its own gets nothing.
 * A browser without the API is refused: a write is not worth the guess.
 */
